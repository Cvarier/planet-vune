...
Our milestones included building a Vue.js / Vuex / Vue-router, a components-based backend with almost no prior Vue experience and using Firebase to integrate
